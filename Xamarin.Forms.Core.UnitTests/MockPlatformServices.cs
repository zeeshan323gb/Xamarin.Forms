...
namespace Xamarin.Forms.Core.UnitTests
{
	internal class MockPlatformServices : Internals.IPlatformServices
	{
		...
		readonly Func<VisualElement, double, double, SizeRequest> getNativeSizeFunc;
		...
		public MockPlatformServices (Action<Action> invokeOnMainThread = null, Action<Uri> openUriAction = null, 
			...
			Func<VisualElement, double, double, SizeRequest> getNativeSizeFunc = null, bool useRealisticLabelMeasure = false)
		{
