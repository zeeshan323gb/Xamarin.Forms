...
namespace Xamarin.Flex
{
    ...
    class NativeFunctions
    {
        ...
        [DllImport(dll_name, CallingConvention = CallingConvention.Cdecl)] public static extern int flex_item_count (IntPtr arg1);
        [DllImport(dll_name, CallingConvention = CallingConvention.Cdecl)] public static extern IntPtr flex_item_delete (IntPtr arg1, int arg2);
        ...
        [DllImport(dll_name, CallingConvention = CallingConvention.Cdecl)] public static extern void flex_item_insert (IntPtr arg1, int arg2, IntPtr arg3);
    ...
    partial class Item
    {
        public Xamarin.Flex.Align AlignContent
        {
			get { return (Xamarin.Flex.Align)flex_item_get_align_content(item); }
            set
            {
		...
		public Xamarin.Flex.Align AlignItems
        {
			get { return (Xamarin.Flex.Align)flex_item_get_align_items(item); }
            set
            {
		...
		public Xamarin.Flex.Align AlignSelf
        {
			get { return (Xamarin.Flex.Align)flex_item_get_align_self(item); }
            set
            {
		...
		public Xamarin.Flex.Direction Direction
        {
			get { return (Xamarin.Flex.Direction)flex_item_get_direction(item); }
            set
            {
		...
		public Xamarin.Flex.Align JustifyContent
        {
			get { return (Xamarin.Flex.Align)flex_item_get_justify_content(item); }
            set
            {
		...
		public Xamarin.Flex.Position Position
        {
			get { return (Xamarin.Flex.Position)flex_item_get_position(item); }
            set
            {
		...
		public Xamarin.Flex.Wrap Wrap
        {
			get { return (Xamarin.Flex.Wrap)flex_item_get_wrap(item); }
            set
            {
