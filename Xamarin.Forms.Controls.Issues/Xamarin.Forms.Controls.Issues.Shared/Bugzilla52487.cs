...
// Set a breakpoint anywhere in OnSelectTemplate around line 206
// Scroll the middle list view to hit breakpoint
// Select first stack frame in "Xamarin.Forms.Platform.Android": 
// >	0x66 in Xamarin.Forms.Platform.Android.ListViewAdapter.GetCellsFromPosition at 
//			C:\Users\Public\Documents\git\forms\Xamarin.Forms.Platform.Android\Renderers\StepperRenderer.cs:34,5	C#
		...
		public abstract partial class ListViewSpy<T> : ListViewSpy
		{
			...
			abstract class Selector : DataTemplateSelector
			{
				...
				internal class SelectByData : Selector
				{
					public SelectByData()
					{
						_dataTemplate = new DataTemplate(ActivateNormalCell);
						_dataTemplateAlt = new DataTemplate(ActivateAlternativeCell);
					}
					private object ActivateNormalCell()
					{
						return new ItemViewCell.Selected.ByDataNormal();
					}
					...
					protected override DataTemplate OnSelectTemplate(object item, BindableObject container)
					{
						...
						if (data % DataTemplateModulous == 0)
				...
				internal class SelectByType : Selector
				{
					public SelectByType()
					{
						_dataTemplate = new DataTemplate(typeof(ItemViewCell.Selected.ByDataNormal));
						_dataTemplateAlt = new DataTemplate(typeof(ItemViewCell.Selected.ByDataAlternate));
					}
				...
				internal abstract class Selected : ItemViewCell
				{
					...
					internal abstract class ByData : Selected
					{
						...
						protected override void OnBindingContextChanged()
						{
							...
							if (templateType != expectedTemplateType)
							{
								var message = $"Item.Id = {BindingContext?.Id}, " +
									$"TemplateType {templateType.Name}!={expectedTemplateType.Name}";
